<html>
<body>
	<h1>This is an alert from Safety Team <?php echo $group_name ?></h1>
	<p>There was a notification from Safety Sam that a Serious Situation has arisen.  Please click <?php echo secure_anchor('/sign_in', 'this link');?> to take action.</p>
